...
namespace FacebookSample.Android
{
	...
	public class Activity1 : Activity
	{
		...
		private const string AppId = "599862353421638";
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			Button btnLogin = null;// FindViewById<Button> (Resource.Id.btnLogin);
			Button btnPostWall = null;//FindViewById<Button> (Resource.Id.btnPostWall);
			Button btnRemovePost = null;// FindViewById<Button> (Resource.Id.btnRemovePost);
			Button btnGraphSample = null;//FindViewById<Button> (Resource.Id.btnGraphSample);
			Button btnFQLSample = null;//FindViewById<Button> (Resource.Id.btnFQLSample);


			btnLogin.Click += (sender, e) => {
				Intent webAuth = null;// new Intent (this, typeof (FBWebViewAuthActivity));
		...
		protected override void OnActivityResult (int requestCode, Result resultCode, Intent data)
		{
			...
			case Result.Ok:
				...
				ImageView imgUser = null;//FindViewById<ImageView> (Resource.Id.imgUser);
					TextView txtvUserName = null;//FindViewById<TextView> (Resource.Id.txtvUserName);
